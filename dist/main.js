...
/*!************************!*\
  !*** ./src/buttons.js ***!
  \************************/
/*! exports provided: play, select, updateSelect, reset, createCheckBoxes, checkCountry, clearBoxes, clearAllChecks, checkListener, sliderListener */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"tip\", function() { return tip; });\n/* harmony import */ var _chart_area_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chart-area.js */ \"./src/chart-area.js\");\n/* harmony import */ var _scales_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scales.js */ \"./src/scales.js\");\n\n\n\nconst tip = d3.tip().attr('class', 'd3-tip') // class to match css\n  // set html with a function\n  .html(d => {\n    let text = `<strong>Country:</strong> <span style='color: ${Object(_scales_js__WEBPACK_IMPORTED_MODULE_1__[\"continentColor\"])(d.continent)}'>` + d.country + \"</span><br>\";\n    text += `<strong>Continent:</strong> <span style='color: ${Object(_scales_js__WEBPACK_IMPORTED_MODULE_1__[\"continentColor\"])(d.continent)}; text-transform: capitalize'>` + d.continent + \"</span><br>\";\n    text += `<strong>Life Expectancy:</strong> <span style='color: ${Object(_scales_js__WEBPACK_IMPORTED_MODULE_1__[\"continentColor\"])(d.continent)}'>` + d3.format(\".2f\")(d.life_exp) + \"</span><br>\";\n    text += `<strong>GDP Per Capita:</strong> <span style='color: ${Object(_scales_js__WEBPACK_IMPORTED_MODULE_1__[\"continentColor\"])(d.continent)}'>` + d3.format(\"($.2f\")(d.income) + \"</span><br>\";\n    text += `<strong>Population:</strong> <span style='color: ${Object(_scales_js__WEBPACK_IMPORTED_MODULE_1__[\"continentColor\"])(d.continent)}'>` + d3.format(\",.0f\")(d.population) + \"</span><br>\";\n\n    return text;\n  });\n// #2E4B69\n// use call method to set context\n_chart_area_js__WEBPACK_IMPORTED_MODULE_0__[\"g\"].call(tip);\n\n\n//# sourceURL=webpack:///./src/tooltip.js?");
